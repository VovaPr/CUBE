...
N'DECLARE @TargetInstanceName NVARCHAR(256) = CAST(ISNULL(CAST(SERVERPROPERTY(''InstanceName'') AS NVARCHAR(256)), N''MSSQLSERVER'') AS NVARCHAR(256));' + CHAR(13) + CHAR(10) + CHAR(13) + CHAR(10) +
