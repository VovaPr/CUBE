...
| 4 | `setup/04_validation.sql` | Creates a temporary failing validation job, runs the alert job, verifies Database Mail sent the alert email, and removes the temporary job |
